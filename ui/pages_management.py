...
def page_properties():
    ...
    for p in props:
        with st.container(border=True):
            ...
            # Property GPS Location & Ghana Rent Card Upload Portal
            with st.expander("📍 Property GPS Location & Ghana Rent Card Portal", expanded=False):
                render_landlord_gps_and_rentcard_widget(property_id=p["id"])
...
def page_leases():
    ...
    for l in leases:
        with st.container(border=True):
            ...
            # Landlord Tenancy Agreement Manager (Default, Typed Custom, or PDF Upload)
